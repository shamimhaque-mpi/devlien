...
export default class Template {
  ...
  async build(file, isExtendable = false) {
    ...
    if (isExtendable)
      return await this.processExtends(
        comtent,
        file.replace(this.fileExtension, '')
      );
    else return await this.processIncludes(comtent, file);
  }
